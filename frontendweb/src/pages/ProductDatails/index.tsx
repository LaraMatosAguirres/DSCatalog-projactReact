          ...
          <div className="col-xl-6">
            <div className="decription-container">
              ...
              <p>
                ...
                consequatur maxime nostrum accusantium. Officiis ut consequuntur
                voluptatum placeat eum dolorem, optio quasi? Voluptas porro
                saepe, maxime quam dicta tenetur magnam.
              </p>
            </div>
          </div>
        </div>
